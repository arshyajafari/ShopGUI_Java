...
public class Theme {
    ...
    public static final Color BACKGROUND_PANEL = new Color(250, 245, 233);
    public static final Color BACKGROUND_HEADER = new Color(110, 110, 110);
    public static final Color COLOR_TITLE = new Color(0, 0, 0);
    public static final Color COLOR_BUTTON_PRIMARY = new Color(255, 255, 255);
    public static final Color BACKGROUND_BUTTON_PRIMARY = new Color(255, 204, 0);
    public static final Color BACKGROUND_TITLE = new Color(186, 255, 57);
